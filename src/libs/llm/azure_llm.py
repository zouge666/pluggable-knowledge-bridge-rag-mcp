...
class AzureLLM(BaseLLM):
    ...
    支持通过 Azure OpenAI Service 调用部署的模型。
    """
    ...
    def __init__(self, settings) -> None:
        ...
        self.deployment_name = settings.deployment_name or settings.model
        ...
        self.api_version = settings.api_version or "2024-02-15-preview"
